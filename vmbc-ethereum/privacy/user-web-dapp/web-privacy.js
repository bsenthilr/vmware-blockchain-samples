...
async function privacyWalletConfig(skey, pkey, cert) {
    ...
    try {
        ...
        let resp = await privacy_wallet.configure(values.privacyContractAddress, values.getPrivateTokenAbi(), skey, pkey, values.getUserId());
    ...
    try {
        ...
        let resp = await privacy_wallet.register(values.privacyContractAddress, values.getPrivateTokenAbi(), undefined, cert);
